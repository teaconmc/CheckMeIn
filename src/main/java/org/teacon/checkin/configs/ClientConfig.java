...
public class ClientConfig {
    ...
    public final IntValue checkPointSuggestDistance;
    ...
    private ClientConfig(ForgeConfigSpec.Builder builder) {
        ...
        checkPointSuggestDistance = builder.comment("Max render distance of suggestions of check points when holding Path Navigator or Camera")
                .translation("configs.check_in.check_point_suggest_distance")
                .defineInRange("check_point_suggest_distance", 16, 0, 1024);
